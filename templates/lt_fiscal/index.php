...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <jdoc:include type="modules" name="coluna-1" style="xhtml" />
            </div>
            <div class="col-md-3">
                <jdoc:include type="modules" name="coluna-2" style="xhtml" />
            </div>
            <div class="col-md-3">
                <jdoc:include type="modules" name="coluna-3" style="xhtml" />
            </div>
            <div class="col-md-3">
                <jdoc:include type="modules" name="coluna-4" style="xhtml" />
            </div>
        </div>
    </div>
</footer>
